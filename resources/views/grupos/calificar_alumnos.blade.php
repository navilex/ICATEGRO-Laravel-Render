    ...
    <div class="container mx-auto px-4 py-6 max-w-7xl text-sm">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 lg:p-10 mb-8 border border-gray-200">
            ...
            <div class="relative mb-8 text-center mt-12">
                ...
                <div class="relative flex justify-center">
                    <span class="px-6 py-1 bg-gray-600 text-white rounded-full text-lg shadow-md border-2 border-gray-500">Calificar alumnos</span>
                </div>
            </div>
        ...
        <form action="{{ route('grupos.calificar.store', $grupo->id) }}" method="POST" id="formCalificar">
            ...
            <div class="overflow-x-auto bg-white rounded shadow-sm border border-gray-200 mt-4 mb-4">
                <table id="alumnos_table" class="w-full text-left border-collapse min-w-max text-xs sm:text-sm">
                    ...
                    <tbody class="text-center text-gray-700 font-semibold border-b border-gray-200 bg-gray-50 text-[11px]">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100 transition">
                                ...
                                <td class="py-3 px-2">
                                    <div class="relative w-full">
                                        <select name="alumnos[{{ $index }}][estatus]" class="estatus-select w-full border-2 border-gray-300 rounded-full py-1 text-xs px-3 focus:outline-none focus:border-blue-400 bg-white shadow-sm font-bold text-gray-600" required>
                                            ...
                                            <option value="BAJA" {{ $ins->student_status === 'BAJA' ? 'selected' : '' }}>BAJA</option>
                                ...
                                <td class="py-3 px-2">
                                    <div class="relative w-full">
                                        <select name="alumnos[{{ $index }}][calificacion]" class="calificacion-select w-full border-2 border-gray-300 rounded-full py-1 text-xs px-3 focus:outline-none focus:border-blue-400 bg-white shadow-sm font-bold text-gray-600" required>
                                            <option value="">» SELECCIONE</option>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center py-6 text-gray-500 font-bold">No hay alumnos inscritos en este grupo para calificar.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="flex justify-between items-center bg-teal-50 border-t border-teal-100 p-4 rounded-b-lg mt-8 shadow-inner">
                ...
                <button type="submit" id="btnGuardarCalificaciones" class="bg-[#1f2937] hover:bg-black text-white font-bold py-2 px-6 rounded-lg flex items-center transition shadow-md border border-gray-800">
