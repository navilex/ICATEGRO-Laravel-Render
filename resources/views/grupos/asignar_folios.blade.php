    ...
    <div class="container mx-auto px-4 py-6 max-w-7xl text-sm">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 lg:p-10 mb-8 border border-gray-200">
            ...
            <div class="relative mb-8 text-center mt-6">
                ...
                <div class="relative flex justify-center">
                    <span
                        class="px-6 py-1 bg-gray-600 text-white rounded-full text-lg shadow-md border-2 border-gray-500">Folios</span>
                </div>
            </div>
            ...
            <form action="{{ route('grupos.folios.store', $grupo->id) }}" method="POST" id="formFolios">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 px-4">
                    <div>
                        ...
                        <select name="doc_type" id="doc_type"
                            class="w-full border-2 border-gray-400 rounded-full py-2 px-4 focus:outline-none focus:border-red-500 font-bold text-gray-700 uppercase shadow-sm"
                            required>
                    ...
                    <div>
                        ...
                        <div class="flex">
                            <input type="text" name="folio_inicial" placeholder="Ej: SR-0000001"
                                class="w-full border-2 border-gray-400 rounded-full py-2 px-4 focus:outline-none focus:border-red-500 font-bold text-gray-700 uppercase shadow-sm"
                                required>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="flex">
                            <input type="text" name="folio_final" placeholder="Ej: SR-0000100"
                                class="w-full border-2 border-gray-400 rounded-full py-2 px-4 focus:outline-none focus:border-red-500 font-bold text-gray-700 uppercase shadow-sm"
                                required>
                        </div>
                    </div>
                ...
                <div class="relative mb-8 text-center mt-6">
                    ...
                    <div class="relative flex justify-center">
                        <span
                            class="px-6 py-1 bg-gray-600 text-white rounded-full text-lg shadow-md border-2 border-gray-500">Listado
                            de folios de alumnos</span>
                    </div>
                </div>
                                ...
                                @if($alumno)
                                    <tr class="border-b border-gray-200 hover:bg-gray-100 transition">
                                        <td class="py-3 px-2 flex justify-center space-x-2">
                                            @if($isAprobado && !empty($ins->folio))
                                                <a href="javascript:void(0)"
                                                    class="text-red-500 hover:text-red-700 transition btn-cancelar-folio"
                                                    title="Cancelar folio" data-id="{{ $ins->id }}" data-idalumno="{{ $alumno->id }}"
                                                    data-curp="{{ $alumno->curp }}" data-name="{{ $alumno->name }}"
                                                    data-app1="{{ $alumno->lastname1 }}" data-app2="{{ $alumno->lastname2 }}"
                                                    data-doctype="{{ $ins->doc_type }}" data-folio="{{ $ins->folio }}">
                                                    <i class="fas fa-ban text-lg"></i>
                                                </a>
                                                <a href="javascript:void(0)"
                                                    class="text-purple-700 hover:text-purple-900 transition btn-change-folio"
                                                    title="Cambiar folio" data-id="{{ $ins->id }}" data-idalumno="{{ $alumno->id }}"
                                                    data-curp="{{ $alumno->curp }}" data-name="{{ $alumno->name }}"
                                                    data-app1="{{ $alumno->lastname1 }}" data-app2="{{ $alumno->lastname2 }}"
                                                    data-doctype="{{ $ins->doc_type }}" data-folio="{{ $ins->folio }}">
                                        ...
                                        <td class="py-3 px-2 text-left w-32">
                                            @if($isAprobado)
                                                <span class="text-green-600 font-bold uppercase"><i
                                                        class="fas fa-thumbs-up mr-2 text-lg"></i> APROBADO</span>
                                            @elseif($ins->student_status === 'NO APROBADO')
                                                <span class="text-red-500 font-bold uppercase"><i
                                                        class="fas fa-thumbs-down mr-2 text-lg"></i> NO APROBADO</span>
                                            @elseif($ins->student_status === 'BAJA')
                                                <span class="text-blue-800 font-bold uppercase"><i
                                                        class="fas fa-user-minus mr-2 text-lg"></i> BAJA</span>
                                            @elseif($ins->student_status === 'DESERCION')
                                                <span class="text-orange-500 font-bold uppercase"><i
                                                        class="fas fa-walking mr-2 text-lg"></i> DESERCION</span>
                                            @else
                                                -
                                            @endif
                                        </td>
                                        <td class="py-3 px-2 text-left w-36">
                                            @if($isAprobado)
                                                <span class="text-green-600 font-bold uppercase doc-type-display"><i
                                                        class="fas fa-file-contract mr-2 text-lg"></i> CONSTANCIA</span>
                                            @else
                                                <span class="text-red-500 font-bold uppercase"><i
                                                        class="fas fa-file-excel mr-2 text-lg"></i> NO APLICA</span>
                                            @endif
                                        </td>
                                        <td class="py-3 px-2 text-gray-500 uppercase font-black tracking-wide bg-gray-100">
                                            {{ $isAprobado ? ($ins->folio ?? 'PENDIENTE') : '' }}</td>
                                    </tr>
                                @endif
                            @empty
                                <tr>
                                    <td colspan="10" class="text-center py-6 text-gray-500 font-bold">No hay alumnos inscritos
                                        en este grupo para asignar folios.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div
                    ...
                    @if($grupo->listaAlumnos->where('student_status', 'APROBADO')->count() > 0)
                        <button type="submit" id="btnGuardarFolios"
            ...
            <div id="modalCambioFolio"
                ...
                <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl transform transition-all">
                    <form id="formCambioFolio">
                        ...
                        <!-- Header -->
                        <div
                            class="flex justify-between items-center bg-white border-b border-gray-200 p-4 rounded-t-lg shadow-sm">
                            <h3 class="text-lg font-extrabold text-gray-800 flex items-center uppercase tracking-wide">
                                <span
                                    class="bg-indigo-100 w-8 h-8 rounded-full flex items-center justify-center mr-3 shadow text-indigo-500"><i
                                        class="fas fa-file-invoice text-sm"></i></span>
                                CAMBIO DE FOLIO
                            </h3>
                            <button type="button"
                        ...
                        <div class="p-6 md:p-8">
                            <div class="flex flex-col md:flex-row gap-6 mb-4">
                                <div class="w-full md:w-1/3">
                                    ...
                                    <input type="text" id="change_id_alumno" disabled
                                        class="w-full border-2 border-gray-400 rounded-full p-2 px-4 bg-white font-bold text-center text-gray-700 text-sm shadow-sm">
                                </div>
                                <div class="w-full md:w-2/3">
                                    <label class="block text-center text-[#a02142] font-bold mb-1">CURP</label>
                                    <input type="text" id="change_curp" disabled
                                        class="w-full border-2 border-gray-400 rounded-full p-2 px-4 bg-white font-bold text-center text-gray-700 text-sm shadow-sm uppercase">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                <div>
                                    ...
                                    <input type="text" id="change_nombre" disabled
                                        class="w-full border-2 border-gray-400 rounded-full p-2 px-4 bg-white font-bold text-center text-gray-700 text-sm shadow-sm uppercase">
                                </div>
                                <div>
                                    <label class="block text-center text-[#a02142] font-bold mb-1">Apellido 1</label>
                                    <input type="text" id="change_app1" disabled
                                        class="w-full border-2 border-gray-400 rounded-full p-2 px-4 bg-white font-bold text-center text-gray-700 text-sm shadow-sm uppercase">
                                </div>
                                <div>
                                    <label class="block text-center text-[#a02142] font-bold mb-1">Apellido 2</label>
                                    <input type="text" id="change_app2" disabled
                                        class="w-full border-2 border-gray-400 rounded-full p-2 px-4 bg-white font-bold text-center text-gray-700 text-sm shadow-sm uppercase">
                                </div>
                            </div>

                            <h4
                                class="text-center font-bold text-gray-800 mb-4 tracking-wide uppercase border-t pt-4 border-gray-300">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="change_doctype" disabled
                                    class="w-full border-2 border-gray-400 rounded-full p-2 px-4 bg-white font-bold text-gray-700 text-sm shadow-sm uppercase text-center">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        <input type="text" id="change_folio_prefix" disabled
                                            class="w-16 border-2 border-gray-400 border-r-0 rounded-l-full p-2 bg-gray-100 text-gray-500 font-bold text-sm text-center">
                                        <input type="text" id="change_folio_num" disabled
                                            class="w-full border-2 border-gray-400 rounded-r-full p-2 px-4 bg-white text-gray-800 font-bold text-sm shadow-sm">
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-center text-[#a02142] font-bold mb-1">* Folio nuevo</label>
                                    <div class="flex items-center">
                                        <input type="text" id="change_new_prefix" disabled
                                            class="w-16 border-2 border-gray-400 border-r-0 rounded-l-full p-2 bg-gray-100 text-gray-500 font-bold text-sm text-center">
                                        <input type="text" id="change_new_num"
                                            class="w-full border-2 border-gray-400 rounded-r-full p-2 px-4 bg-white text-gray-800 font-bold text-sm shadow-sm"
                            ...
                            <div>
                                ...
                                <textarea name="motivo_cambio" rows="3"
                                    class="w-full border-2 border-gray-400 rounded-xl p-3 focus:outline-none focus:border-red-500 bg-white font-bold text-gray-700 text-sm shadow-sm resize-none"
                                    required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end bg-gray-50 border-t border-gray-200 p-4 rounded-b-lg space-x-3">
                            <button type="button"
                                class="close-modal bg-[#dc3545] hover:bg-[#c82333] text-white font-bold py-2 px-6 rounded flex items-center transition shadow-sm text-sm border border-[#d43f3a]">
                                <i class="fas fa-times-circle mr-2"></i> Cerrar
                            </button>
                            <button type="submit" id="btnProcesarCambio"
                                class="bg-[#198754] hover:bg-[#157347] text-white font-bold py-2 px-6 rounded flex items-center transition shadow-sm text-sm border border-[#146c43]">
                ...
                <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl transform transition-all">
                    <form id="formCancelarFolio">
                        ...
                        <div
                            ...
                            <h3 class="text-lg font-extrabold text-gray-800 flex items-center uppercase tracking-wide">
                                <span
                                    class="bg-red-100 w-8 h-8 rounded-full flex items-center justify-center mr-3 shadow text-red-500"><i
                                        class="fas fa-file-excel text-sm"></i></span>
                                CANCELAR FOLIO
                            </h3>
                            <button type="button"
                                class="close-modal bg-red-100 hover:bg-red-200 text-red-500 rounded-full w-8 h-8 flex items-center justify-center border border-red-200 transition">
                        ...
                        <div class="p-6 md:p-8">
                            <div class="flex flex-col md:flex-row gap-6 mb-4">
                                <div class="w-full md:w-1/3">
                                    <label class="block text-center text-[#a02142] font-bold mb-1">ID alumno</label>
                                    <input type="text" id="cancel_id_alumno" disabled
                                        class="w-full border-2 border-gray-400 rounded-full p-2 px-4 bg-white font-bold text-center text-gray-700 text-sm shadow-sm">
                                </div>
                                <div class="w-full md:w-2/3">
                                    <label class="block text-center text-[#a02142] font-bold mb-1">CURP</label>
                                    <input type="text" id="cancel_curp" disabled
                                        class="w-full border-2 border-gray-400 rounded-full p-2 px-4 bg-white font-bold text-center text-gray-700 text-sm shadow-sm uppercase">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                <div>
                                    <label class="block text-center text-[#a02142] font-bold mb-1">Nombre</label>
                                    <input type="text" id="cancel_nombre" disabled
                                        class="w-full border-2 border-gray-400 rounded-full p-2 px-4 bg-white font-bold text-center text-gray-700 text-sm shadow-sm uppercase">
                                </div>
                                <div>
                                    <label class="block text-center text-[#a02142] font-bold mb-1">Apellido 1</label>
                                    <input type="text" id="cancel_app1" disabled
                                        class="w-full border-2 border-gray-400 rounded-full p-2 px-4 bg-white font-bold text-center text-gray-700 text-sm shadow-sm uppercase">
                                </div>
                                <div>
                                    <label class="block text-center text-[#a02142] font-bold mb-1">Apellido 2</label>
                                    <input type="text" id="cancel_app2" disabled
                                        class="w-full border-2 border-gray-400 rounded-full p-2 px-4 bg-white font-bold text-center text-gray-700 text-sm shadow-sm uppercase">
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <label class="block text-center text-[#a02142] font-bold mb-1">Tipo de documento</label>
                                <input type="text" id="cancel_doctype" disabled
                                    class="w-full border-2 border-gray-400 rounded-full p-2 px-4 bg-white font-bold text-gray-700 text-sm shadow-sm uppercase text-center">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    <label class="block text-center text-[#a02142] font-bold mb-1">Folio actual</label>
                                    <div class="flex items-center">
                                        <input type="text" id="cancel_folio_prefix" disabled
                                            class="w-16 border-2 border-gray-400 border-r-0 rounded-l-full p-2 bg-gray-100 text-gray-500 font-bold text-sm text-center">
                                        <input type="text" id="cancel_folio_num" disabled
                                            class="w-full border-2 border-gray-400 rounded-r-full p-2 px-4 bg-white text-gray-800 font-bold text-sm shadow-sm">
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-center text-[#a02142] font-bold mb-1">* Estatus nuevo</label>
                                    <select name="estatus_nuevo"
                                        class="w-full border-2 border-gray-400 rounded-full p-2 px-4 focus:outline-none focus:border-red-500 font-bold text-gray-700 text-sm shadow-sm"
                                        required>
                            ...
                            <div>
                                <label class="block text-center text-[#a02142] font-bold mb-1">* Motivo de la
                                    cancelación</label>
                                <textarea name="motivo_cancelacion" rows="3" maxlength="200"
                                    class="w-full border-2 border-gray-400 rounded-xl p-3 focus:outline-none focus:border-red-500 bg-white font-bold text-gray-700 text-sm shadow-sm resize-none"
                                    required></textarea>
                        ...
                        <div class="flex justify-end bg-gray-50 border-t border-gray-200 p-4 rounded-b-lg space-x-3">
                            ...
                            <button type="submit" id="btnProcesarCancelar"
                                class="bg-[#198754] hover:bg-[#157347] text-white font-bold py-2 px-6 rounded flex items-center transition shadow-sm text-sm border border-[#146c43]">
